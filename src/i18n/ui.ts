...
export const ui = {
  en: {
    ...
    'chatbot.title': 'Daniel GPT',
    'chatbot.status': 'Online',
    'chatbot.placeholder': 'Type your message...',
    'chatbot.welcome': 'Hello! I\'m Daniel GPT, a chatbot developed with RAG architecture. I can help you with information about Daniel\'s professional profile and also schedule interviews. How can I help you today?',
  ...
  es: {
    ...
    'chatbot.welcome': '¡Hola! Soy Daniel GPT, un chatbot desarrollado con arquitectura RAG. Puedo ayudarte con información sobre su perfil profesional y también puedo agendar entrevistas. ¿En qué puedo ayudarte hoy?',
